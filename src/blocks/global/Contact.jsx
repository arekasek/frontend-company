...
export default function Contact() {
  return (
    <div
      id="Kontakt"
      className="w-full h-auto bg-[#444444c9] flex md:flex-row flex-col-reverse bg-[#555555] text-white"
    >
      <iframe
        ...
        className="md:w-[50%] w-full md:h-auto h-[30vh]"
      ></iframe>
      <div className="md:w-[50%] w-full p-8 md:p-12 flex flex-col justify-center">
        <div className="w-[90%]">
