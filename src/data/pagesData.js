export const pagesData = {
  home: {
    ...
    metaDescription:
      "Firma Woj-Płot, działająca na rynku od 2000 roku z bazą w Lęborku, oferuje najwyższej jakości usługi z zakresu kowalstwa w tym bramy, ogrodzenia, balustrady, meble oraz inne.",
    metaImage: "/logo.png",
    layout: [
      {
        blockType: "TwoColumn",
